...
Modul logic distro "Development" yang membungkus `window.NxDirectory`
...
> ini yang khusus distro "Development"). Dokumen ini fokus ke satu
...
`templates/distro/Development/package/directory/index.js`.
...
(`nx-directory-tree-last-open-file::Development`) setiap kali file berhasil
