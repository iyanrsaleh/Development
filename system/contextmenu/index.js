// Titik registrasi context-menu per-target extension "Development".
...
// nxLauncherItem — target DINAMIS launcher (system/shortcut/index.js):
// banyak id nxlauncher::<id-encoded>, satu per tile shortcut.
import * as nxLauncherItemMod from './nxLauncherItem.js';
...
const REGISTRY = [
  ...
  },
  {
    ...
    module: nxLauncherItemMod,
    buildMenu: 'nxLauncherItem',
  },
];
